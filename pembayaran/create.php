...
<html lang="en">
  <head>
    ...
    <title>Tambah Jurusan | PPDB</title>
  </head>
  <body>
    <!-- NAVBAR -->
    ...
    <br>
        ...
        <div class="card">
            ...
            <center><h2>Tambah Data <br>Pembayaran</h2></center>
            </div>
            <div class="card-body">
            ...
            <form action="proses.php" method="post">
                <input type="hidden" name="aksi" value="create">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="uang_pendaftaran">
                        <small id="emailHelp" class="form-text text-muted">Kolom ini harus diisi!</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Uang Seragam</label>
                        <input type="text" class="form-control" name="uang_seragam">
                        <small id="emailHelp" class="form-text text-muted">Kolom ini harus diisi!</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Uang Kegiatan</label>
                        <input type="text" class="form-control" name="uang_kegiatan">
                        <small id="emailHelp" class="form-text text-muted">Kolom ini harus diisi!</small>
                    </div>
